...
export class Contract {
  ...
  constructor(...args_0) {
    ...
    this.circuits = {
      joinAllowlist: (...args_1) => {
        if (args_1.length !== 2) {
          throw new __compactRuntime.CompactError(`joinAllowlist: expected 2 arguments (as invoked from Typescript), received ${args_1.length}`);
        }
        const contextOrig_0 = args_1[0];
        const secretCode_0 = args_1[1];
        ...
        const partialProofData = {
          input: {
            value: _descriptor_1.toValue(secretCode_0),
        ...
        const result_0 = this._joinAllowlist_0(context,
                                               partialProofData,
                                               secretCode_0);
    ...
    this.impureCircuits = { joinAllowlist: this.circuits.joinAllowlist };
    this.provableCircuits = { joinAllowlist: this.circuits.joinAllowlist };
  }
  initialState(...args_0) {
    if (args_0.length !== 1) {
  ...
  _joinAllowlist_0(context, partialProofData, secretCode_0) {
    const tmp_0 = 1n;
    __compactRuntime.queryLedgerState(context,
                                      partialProofData,
                                      [
